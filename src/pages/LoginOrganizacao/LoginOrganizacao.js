...
import { logarOrganizacao, logarUsuario } from "../../services/usuario/usuario";

const LoginOrganizacao = () => {
  ...
  async function login() {
    try {
      const response = await logarOrganizacao({ email, senha });
...
export default LoginOrganizacao;
